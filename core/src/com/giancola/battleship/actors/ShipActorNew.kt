...
class ShipActorNew(val shipId: Pair<ShipType, Int>, private val tileSize: Float = TILE_SIZE): Actor() {
    ...
    fun placeInGrid(coords: Pair<GridPoint2, GridPoint2>, board: CombatPlayerBoard) {
